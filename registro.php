...
$sql = "INSERT INTO infCliente (descr,tipo,tipo2,tipo3,tipo4,tipo5,tipo6,tipo7,tipo8,colorprimario, colorsecundario, coloradicional, diseno, navE, navG, navT, navstac, infoprincipal1, infoprincipal2, infoprincipal4, infoprincipal5, infoprincipal3, infoprincipal10, infoprincipal20, infoprincipal40) 
       VALUES (
       '".$com."'
       ,'".$tip1."'
       ,'".$tip2."'
...
echo'<script type="text/javascript">
    alert("Gracias tu informacion ha sido almacenada con exito ");
