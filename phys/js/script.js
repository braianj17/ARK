...
(function () {
	...
	$( function () {
		...
		function initMaps() {
			...
			$.getScript('http://maps.google.com/maps/api/js?'+ ( key ? 'key='+ key + '&' : '' ) +'sensor=false&libraries=geometry,places&v=quarterly', function () {
		...
		if (plugins.rdMailForm.length) {
			...
			for (let i = 0; i < plugins.rdMailForm.length; i++) {
